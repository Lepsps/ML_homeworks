...
**Бизнес-контекст:**
Основная цель — найти лучшие стратегии для повышения эффективности будущих маркетинговых кампаний банка. Для этого необходимо проанализировать данные последней проведенной кампании, выявить закономерности и построить модель, которая позволит концентрировать ресурсы на наиболее перспективных клиентах, что повысит конверсию и снизит затраты.

**Задача машинного обучения:**
Построить модель бинарной классификации, которая на основе данных о клиенте и предыдущих контактах предсказывает значение целевой переменной `deposit` ('yes' или 'no')
